		...
		<div class="rightsidebar_box rt">
			<div class="rs_header">
				<span class="rs_header_active"><a
					href="${pageContext.request.contextPath}/user/showpersoninfo.do">我的信息</a></span>
				<span><a
					href="${pageContext.request.contextPath}/user/spassword.do">安全管理</a></span>
			</div>
			...
			<div class="rs_content">
				...
				<div class="rs_content_headPortrait">
					<span class="same">我的头像：</span> <img
						...
						alt="" id="icon" width="50px" height="50px" /> <input
						type="hidden" name="iconPic" value="" id="iconPic"> <span
               ...
               checked
					...
					<div class="rs_content_tel">
						<span class="same">绑定电话：</span> <input type="text"
					...
					<!--保存按钮-->
					<div class="save">
						<a href="#" onclick="btnupdate()"style="color: #fff">保存更改
						</a>
					</div>
				</form>
			</div>
